...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-10">
            <h1 class="text-3xl font-bold text-gray-900">Create Worker</h1>
        ...
        <form method="POST" action="{{ route('admin.workers.store') }}" class="bg-white rounded-2xl shadow-lg p-10 space-y-10 border border-gray-100">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <input type="text" name="work_id" id="work_id" value="{{ old('work_id') }}"
                           class="block w-full px-6 py-5 text-lg border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
