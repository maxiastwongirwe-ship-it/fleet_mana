                ...
                <div>
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->email ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Phone</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->phone ?? '—' }}</dd>
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <dl class="space-y-4">
                        <div>
                            ...
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->worker?->work_id ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">NIN</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->worker?->nin ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Department</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->worker?->department ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Position</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ $worker->worker?->position ?? '—' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Hire Date</dt>
                            <dd class="mt-1 text-lg text-gray-900">
                                {{ $worker->worker?->hire_date?->format('d M Y') ?? '—' }}
                            </dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Employment Type</dt>
                            <dd class="mt-1 text-lg text-gray-900">
                                {{ ucfirst($worker->worker?->employment_type ?? '—') }}
                            </dd>
                        </div>
                    </dl>
                </div>
